...
<head>
    ...
    <title>Login Petugas - Helpdesk</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="login-wrapper">
        <div class="login-card">
            <div class="login-header">
                ...
                <h1>Login Petugas</h1>
                <p>Akses untuk petugas sistem</p>
            </div>

            <div class="role-badge">
                <i class="fas fa-info-circle"></i>
                <span>Untuk: Administrator, Admin, Teknisi</span>
            </div>
            ...
            <form method="POST" action="{{ route('login_petugas.post') }}">
                @csrf
    ...
    @enderror
            ...
            <div class="other-login">
                <a href="{{ route('login_user') }}">👤 Login User</a>
